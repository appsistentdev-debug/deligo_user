...
// Color ratingCardColor = const Color(0xff00A302);
...
// updated by Prateek
Color mainColor = const Color(0xFFF57C00);
Color ratingCardColor = const Color(0xFFF57C00);
Color greyTextColor = const Color.fromARGB(255, 8, 15, 26);
Color greyTextColor2 = const Color.fromARGB(255, 8, 15, 26);
Color greyTextColor3 = const Color.fromARGB(255, 8, 15, 26);
Color cardColor = const Color(0xfff5f7f9);
Color blackColor = Colors.black;
Color darkBottomNavBarColor = Color(0xFF27292E);
...
Color disabledColor = const Color(0xffF4F7F9);
Color indicatorColor = const Color(0xFFDFF6E0);
Color unselectedItemColor = const Color(0xFF0B2A55);
Color selectedColor = const Color(0xFF0B2A55);

Color orderGreen = const Color(0xFFF57C00);
Color orderGreenLight = const Color(0xffE9FFCE);
Color orderOrange = const Color(0xffF3AA1B);
Color orderOrangeLight = const Color(0xffFFEAC2);
Color orderBlack = const Color(0xff27292E);
...
Color gradientColor1 = const Color(0xFFF57C00);
Color gradientColor2 = const Color(0xFFF57C00);

Color darkGradientColor1 = const Color(0xFF0B2A55);
Color lightGradientColor1 = Colors.grey[300]!;
Color darkGradientColor2 = const Color(0xFF0B2A55);
Color lightGradientColor2 = const Color(0xFF0B2A55);
